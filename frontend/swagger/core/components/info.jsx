...
export default class Info extends React.Component {
  ...
  render() {
    let { info, url, host, mode, system, basePath, getComponent, externalDocs } = this.props
...

        {
          (mode === 'single') ? null
            : <div className="system-notice">
              You are currently using the <strong className="ui-system">{system}</strong> system. To switch, you will need
